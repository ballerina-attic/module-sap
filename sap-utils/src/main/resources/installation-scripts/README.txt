...
This guide contains instructions to install the SAP ballerina package into your ballerina installation. This is a one-time task.
...
1. install.{sh/bat} - Installs the sap package.
2. uninstall.{sh/bat} - Uninstalls the sap package if installed already.
